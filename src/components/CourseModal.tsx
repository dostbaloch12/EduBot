...
export default function CourseModal({ course, board = "quetta", onClose, onStartQuiz, onAskTutor, onQAPractice }: CourseModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-[#07061d]/85 p-4 backdrop-blur-xl">
      <div className="glass-strong border-gradient animate-scale-in relative my-8 max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-[2.5rem] p-6 sm:p-8 shadow-2xl">
